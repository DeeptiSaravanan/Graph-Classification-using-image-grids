...
e = '/home/N1801734D/gspannew/id/train/'
out = '/home/N1801734D/grid/graph_2D_CNN/datasets/ten/train/'
filenames=[]
i=0
length = 0
res=[]
...
#res.append(c22)
	...
	with open("lol/train/lol_"+str(i)+".emb","w") as f:
		for item in res:
			f.write("%s\n" % item)

	with open("lol/train/lol_"+str(i)+".emb","r") as f:
        	con = f.read()
        	con1 = con.replace("["," ")
        	con2 = con1.replace("]"," ")
	...
	emb = np.loadtxt("lol/train/lol_"+str(i)+".emb")
#emb=emb[emb[:,0],1:]
