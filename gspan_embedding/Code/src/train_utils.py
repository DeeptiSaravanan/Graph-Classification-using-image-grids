...
def train_skipgram (corpus_dir, extn, learning_rate, embedding_size, num_negsample, epochs, batch_size, output_dir):
    ...
    '''
    op_fname = "/home/N1801734D/example/graph2vec_tf/embeddings/"
   ...
   # if os.path.isfile(op_fname):
    ...
    logging.info('Completed writing the final embeddings, pls check folder: {} for the same'.format(op_fname))
    return op_fname
